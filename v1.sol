...
function name() public payable {  find similar
    v0 = 0x2d8e(_name.length);
    v1 = new bytes[](v0);
    v2 = v3 = v1.data;
    v4 = 0x2d8e(_name.length);
    if (v4) {
        if (31 < v4) {
            v5 = _name.data;
            while (v3 + v4 > v2) {
...
function 0x1e18(uint256 varg0) private { 
    v0 = 0x530();
    v1 = 0x1f4f(v0, 10 ** 18, varg0);
    return v1;
}

function 0x1ebc() private { 
    v0 = 0x2941();
    v1 = 0x29ab();
    MEM[64] += 192;
...
function 0x1ec6(uint256 varg0) private { 
...
function 0x1ed3(uint256 varg0, uint256 varg1) private { 
    require(address(varg1), ERC20InvalidReceiver(0));
    0x24ad(varg0, varg1, 0);
    return ;
}

function 0x1f0d(uint256 varg0, uint256 varg1) private { 
    require(address(varg1), ERC20InvalidSender(0));
    0x24ad(varg0, 0, varg1);
    return ;
}

function 0x1f4f(uint256 varg0, uint256 varg1, uint256 varg2) private { 
    v0 = varg1 * varg2;
...
function approve(address spender, uint256 amount) public payable {  find similar
    ...
    0x21d3(1, amount, spender, msg.sender);
    return True;
}

function 0x20b5(bytes varg0, bytes varg1) private { 
...
function 0x20c7(bytes varg0) private { 
    require(stor_f0c57e16840df040f15088dc2f81fe391c3923bec73e23a9662efc9c229c6a00_8_8, NotInitializing());
    require(stor_f0c57e16840df040f15088dc2f81fe391c3923bec73e23a9662efc9c229c6a00_8_8, NotInitializing());
    require(varg0.length <= uint64.max, Panic(65)); // failed memory allocation (too much memory)
    v0 = 0x2d8e(array_a16a46d94261c7517cc8ff89f61c0ce93598e3c849801011dee649a6a557d102.length);
    if (v0 > 31) {
    ...
    v13 = 0x2d8e(array_a16a46d94261c7517cc8ff89f61c0ce93598e3c849801011dee649a6a557d103.length);
    if (v13 > 31) {
...
function 0x20fc() private { 
    v0 = 0x2d8e(array_a16a46d94261c7517cc8ff89f61c0ce93598e3c849801011dee649a6a557d102.length);
    v1 = new bytes[](v0);
    v2 = v3 = v1.data;
    v4 = 0x2d8e(array_a16a46d94261c7517cc8ff89f61c0ce93598e3c849801011dee649a6a557d102.length);
    if (!v4) {
        return v1;
    } else if (31 < v4) {
...
function 0x213b() private { 
    v0 = 0x2d8e(array_a16a46d94261c7517cc8ff89f61c0ce93598e3c849801011dee649a6a557d103.length);
    v1 = new bytes[](v0);
    v2 = v3 = v1.data;
    v4 = 0x2d8e(array_a16a46d94261c7517cc8ff89f61c0ce93598e3c849801011dee649a6a557d103.length);
    if (!v4) {
        return v1;
    } else if (31 < v4) {
...
function 0x21d3(uint256 varg0, uint256 varg1, address varg2, address varg3) private { 
...
function totalSupply() public payable {  find similar
    v0 = 0x530();
    v1 = 0x1f4f(10 ** 18, v0, _totalShares);
    return v1;
}

function 0x22ba(uint256 varg0, uint256 varg1, uint256 varg2) private { 
    v0 = _allowance[address(varg2)][address(varg1)];
    if (v0 == uint256.max) {
        return ;
    } else {
        require(v0 >= varg0, ERC20InsufficientAllowance(address(varg1), v0, varg0));
        0x21d3(0, v0 - varg0, varg1, varg2);
        return ;
    }
}

function 0x231a(uint256 varg0, uint256 varg1, uint256 varg2) private { 
    require(address(varg2), ERC20InvalidSender(0));
    require(address(varg1), ERC20InvalidReceiver(0));
    0x24ad(varg0, varg1, varg2);
    return ;
}
...
function transferFrom(address sender, address recipient, uint256 amount) public payable {  find similar
    ...
    0x22ba(amount, msg.sender, sender);
    0x231a(amount, recipient, sender);
    return True;
}

function 0x24ad(uint256 varg0, uint256 varg1, uint256 varg2) private { 
    v0 = 0x1e18(varg0);
    0x24c1(v0, varg1, varg2);
    return ;
}

function 0x24c1(uint256 varg0, address varg1, address varg2) private { 
    if (varg2) {
...
function 0x265f(uint256 varg0, uint256 varg1, uint256 varg2) private { 
    require(address(varg2), ERC20InvalidSender(0));
    require(address(varg1), ERC20InvalidReceiver(0));
    0x24c1(varg0, varg1, varg2);
    return ;
}
...
function mint(address to, uint256 amount) public payable {  find similar
    require(msg.data.length - 4 >= 64);
    0x1ec6(0x9f2df0fed2c77648de5860a4cc508cd0818c85b8b8a1ab4ceeef8d981c8956a6);
    v0, /* bool */ v1 = address(0x7ba834024816fa5de620def31d03d12e6f20d2f9).paused().gas(msg.gas);
    require(bool(v0), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
    require(MEM[64] + RETURNDATASIZE() - MEM[64] >= 32);
    require(v1 == bool(v1));
...
function burn(uint256 amount) public payable {  find similar
    ...
    0x1ec6(0x3c11d16cbaffd01df69ce1c404f6340ee057498f5f00246190ea54220576a848);
    v0, /* bool */ v1 = address(0x7ba834024816fa5de620def31d03d12e6f20d2f9).paused().gas(msg.gas);
    require(bool(v0), 0, RETURNDATASIZE()); // checks call status, propagates error data on error
    require(MEM[64] + RETURNDATASIZE() - MEM[64] >= 32);
    require(v1 == bool(v1));
    ...
    0x1f0d(amount, msg.sender);
}

function 0x2941() private { 
    v0 = 0x20fc();
    if (!v0.length) {
        if (!_eip712Domain) {
...
function setMetadata(string varg0, string _description) public payable {  find similar
    ...
    require(v1 == bool(v1));
    require(!v1, Paused());
    0x1ec6(0x7f5260842512b02356ff92de24be96e7e1aac2e234d9371b076ac2b4cddda61e);
    require(varg0.length <= uint64.max, Panic(65)); // failed memory allocation (too much memory)
    v2 = 0x2d8e(_name.length);
    if (v2 > 31) {
        v3 = v4 = _name.data;
...
function 0x2d8e(uint256 varg0) private { 
    v0 = v1 = varg0 >> 1;
    if (!(varg0 & 0x1)) {
        v0 = v2 = v1 & 0x7f;
    }
...
function updateMultiplier(uint256 multiplierNumber) public payable {  find similar
    ...
    require(v1 == bool(v1));
    require(!v1, Paused());
    0x1ec6(0x7158cf42e4a4f01c5456c8d75cdbd375748d45e9db7e812f5bcd18844122b615);
    v2 = 0x530();
...
function transferSharesFrom(address _sender, address _recipient, uint256 _sharesAmount) public payable {  find similar
    ...
    require(v7 == bool(v7));
    require(!v7, Blocked(msg.sender));
    v8 = 0xfea(_sharesAmount);
    0x22ba(v8, msg.sender, _sender);
    0x265f(_sharesAmount, _recipient, _sender);
}

function balanceOf(address account) public payable {  find similar
    require(msg.data.length - 4 >= 32);
    v0 = 0xfea(_sharesOf[account]);
    return v0;
}
...
function transferShares(address _recipient, uint256 _sharesAmount) public payable {  find similar
    ...
    require(v5 == bool(v5));
    require(!v5, Blocked(msg.sender));
    0x265f(_sharesAmount, _recipient, msg.sender);
}
...
function symbol() public payable {  find similar
    v0 = 0x2d8e(_symbol.length);
    v1 = new bytes[](v0);
    v2 = v3 = v1.data;
    v4 = 0x2d8e(_symbol.length);
    if (v4) {
        if (31 < v4) {
            v5 = _symbol.data;
            while (v3 + v4 > v2) {
...
function transfer(address recipient, uint256 amount) public payable {  find similar
    ...
    require(v5 == bool(v5));
    require(!v5, Blocked(msg.sender));
    0x231a(amount, recipient, msg.sender);
    return True;
}
...
function permit(address owner, address spender, uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s) public payable {  find similar
    ...
    v0 = 0x2178(keccak256(0x6e71edae12b1b97f4d1f60370fef10105fa2faae0126114a169c64845d6126c9, owner, spender, value, _nonces[owner], deadline));
...
function 0xfea(uint256 varg0) private { 
    v0 = 0x530();
    v1 = 0x1f4f(10 ** 18, v0, varg0);
    return v1;
}
...
function __function_selector__( function_selector) public payable { 
    ...
    if (msg.data.length >= 4) {
        ...
        if (0x6d780459 > v0) {
            ...
            } else if (0x53735f37 == v0) {
                sharesToBalance(uint256);
            } else {
                require(0x5ffe6146 == v0);
